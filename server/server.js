  ...
  try {
    ...
    const result = Object.keys(teams).map(teamNumber => {
      ...
      return {
        ...
        medStartPreload: median(getFieldValues('startPreload')),
        ...
        medTeleOpFeedHumanMajority: median(getFieldValues('teleOpFeedHumanMajority')),
        medTeleOpDefenceStealling: median(getFieldValues('teleOpDefenceStealling')),
  ...
  try {
    ...
    const matchdata = await MatchData.findAll({
      attributes: [
        'teamNumber',
        [Sequelize.fn('COUNT', Sequelize.col('teamNumber')), 'matchCount'],
        [Sequelize.literal('ROUND(AVG(startTrenchLeft), 2)'), 'avgStartTrenchLeft'],
        [Sequelize.literal('ROUND(AVG(startBumpLeft), 2)'), 'avgStartBumpLeft'],
        [Sequelize.literal('ROUND(AVG(startHub), 2)'), 'avgStartHub'],
        [Sequelize.literal('ROUND(AVG(startBumpRight), 2)'), 'avgStartBumpRight'],
        [Sequelize.literal('ROUND(AVG(startTrenchRight), 2)'), 'avgStartTrenchRight'],
        [Sequelize.literal('ROUND(AVG(startPreload), 2)'), 'avgStartPreload'],
        [Sequelize.literal('ROUND(AVG(teleOpPassNeutralAlliance), 2)'), 'avgTeleOpPassNeutralAlliance'],
        ...
        [Sequelize.literal('ROUND(AVG(postClimbLevelOneRight), 2)'), 'avgPostClimbLevelOneRight'],
        [Sequelize.literal('ROUND(AVG(postClimbLevelOneCenter), 2)'), 'avgPostClimbLevelOneCenter'],
        [Sequelize.literal('ROUND(AVG(postClimbLevelOneLeft), 2)'), 'avgPostClimbLevelOneLeft'],
        [Sequelize.literal('ROUND(AVG(postClimbLevelTwoRight), 2)'), 'avgPostClimbLevelTwoRight'],
        [Sequelize.literal('ROUND(AVG(postClimbLevelTwoCenter), 2)'), 'avgPostClimbLevelTwoCenter'],
        [Sequelize.literal('ROUND(AVG(postClimbLevelTwoLeft), 2)'), 'avgPostClimbLevelTwoLeft'],
        [Sequelize.literal('ROUND(AVG(postClimbLevelThreeRight), 2)'), 'avgPostClimbLevelThreeRight'],
        ...
        [Sequelize.literal('ROUND(AVG(postUnderTrench), 2)'), 'avgPostUnderTrench'],
        [Sequelize.literal('ROUND(AVG(postOverBump), 2)'), 'avgPostOverBump'],
        [Sequelize.literal('ROUND(AVG(postNotThere), 2)'), 'avgPostNotThere'],
        ...
        [Sequelize.literal('ROUND(AVG(AutonNeutralZone), 2)'), 'avgAutonNeutralZone'],
        [Sequelize.literal('ROUND(AVG(AutonClimbLevel), 2)'), 'avgAutonClimbLevel'],
        [Sequelize.literal('ROUND(AVG(AutonOutpost), 2)'), 'avgAutonOutpost'],
        [Sequelize.literal('ROUND(AVG(AutonDepot), 2)'), 'avgAutonDepot'],
        [Sequelize.literal('ROUND(AVG(AutonIntake), 2)'), 'avgAutonIntake'],
...
app.get('/api/v1/matchData/2026/:eventkey/team/:ids/median', async (req, res) => {
  ...
  res.json([{
    ...
    medStartTrenchLeft: median(getFieldValues('startTrenchLeft')),
    medStartBumpLeft: median(getFieldValues('startBumpLeft')),
    medStartHub: median(getFieldValues('startHub')),
    medStartBumpRight: median(getFieldValues('startBumpRight')),
    medStartTrenchRight: median(getFieldValues('startTrenchRight')),
    medStartPreload: median(getFieldValues('startPreload')),
    medTeleOpPassNeutralAlliance: median(getFieldValues('teleOpPassNeutralAlliance')),
    medTeleOpPassOpponentNeutral: median(getFieldValues('teleOpPassOpponentNeutral')),
    medTeleOpPassOpponentAlliance: median(getFieldValues('teleOpPassOpponentAlliance')),
    ...
    medTeleOpShootLittle: median(getFieldValues('teleOpShootLittle')),
    medTeleOpFeedHumanMajority: median(getFieldValues('teleOpFeedHumanMajority')),
    medTeleOpFeedHumanLittle: median(getFieldValues('teleOpFeedHumanLittle')),
    medTeleOpDefenceStealling: median(getFieldValues('teleOpDefenceStealling')),
    medTeleOpDefenceBlocking: median(getFieldValues('teleOpDefenceBlocking')),
    medPostClimbLevelOne: median(rows.map(r => r.postClimbLevelOneRight + r.postClimbLevelOneCenter + r.postClimbLevelOneLeft)),
    medPostClimbLevelTwo: median(rows.map(r => r.postClimbLevelTwoRight + r.postClimbLevelTwoCenter + r.postClimbLevelTwoLeft)),
    medPostClimbLevelThree: median(rows.map(r => r.postClimbLevelThreeRight + r.postClimbLevelThreeCenter + r.postClimbLevelThreeLeft)),
    medPostClimbLevelLeft: median(rows.map(r => r.postClimbLevelOneLeft + r.postClimbLevelTwoLeft + r.postClimbLevelThreeLeft)),
    medPostClimbLevelCenter: median(rows.map(r => r.postClimbLevelOneCenter + r.postClimbLevelTwoCenter + r.postClimbLevelThreeCenter)),
    medPostClimbLevelRight: median(rows.map(r => r.postClimbLevelOneRight + r.postClimbLevelTwoRight + r.postClimbLevelThreeRight)),
    medPostClimbLevelOneRight: median(getFieldValues('postClimbLevelOneRight')),
    medPostClimbLevelOneCenter: median(getFieldValues('postClimbLevelOneCenter')),
    medPostClimbLevelOneLeft: median(getFieldValues('postClimbLevelOneLeft')),
    medPostClimbLevelTwoRight: median(getFieldValues('postClimbLevelTwoRight')),
    medPostClimbLevelTwoCenter: median(getFieldValues('postClimbLevelTwoCenter')),
    medPostClimbLevelTwoLeft: median(getFieldValues('postClimbLevelTwoLeft')),
    medPostClimbLevelThreeRight: median(getFieldValues('postClimbLevelThreeRight')),
    medPostClimbLevelThreeCenter: median(getFieldValues('postClimbLevelThreeCenter')),
    medPostClimbLevelThreeLeft: median(getFieldValues('postClimbLevelThreeLeft')),
    medPostUnderTrench: median(getFieldValues('postUnderTrench')),
    medPostOverBump: median(getFieldValues('postOverBump')),
